...
def cargar_datos():
    ...
    if not usuarios:
        ...
        new_usuario_13 = Usuario (correo= "ivan123@gmail.com", contrasena= '1234', is_active= True, rol= 1, nombre= "Ivan Gonzalez", telefono= '+573006197027', complete= True, latitud= 6.1515344, longitud=-75.6153715)
