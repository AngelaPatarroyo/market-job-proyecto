...
def cargar_datos():
    ...
    if not perfiles:
        new_perfil_freelancer_1 = PerfilFreelancer (tipo_freelancer= 1, usuario_id= 1, descripcion= "Descripción de Prueba", imagen= "https://firebasestorage.googleapis.com/v0/b/market-match-e1c5a.appspot.com/o/market_match%2F2631F0C3-98AC-43EE-ABB2-9B5D89424FA1%202.jpg?alt=media&token=ccf89c12-511c-4ec1-bdf7-6ec40b90b9f0", linkedin= "https://www.linkedin.com/in/karen-margarita-vergara-vicent-68193461/", portafolio= 'https://github.com/karenvicent', tarifa= 50, experiencia_id= 3)
